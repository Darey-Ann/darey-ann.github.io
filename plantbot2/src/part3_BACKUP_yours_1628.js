...
const SUN  = [1.30, 1.03, 0.72]; /* [1.08, 0.86, 0.60];*/
...
function frame(now) {
  ...
  let pulsePhase = 0;                    // next to `let t0 = ...`
  pulsePhase += dt;                      // in frame(), just after dt is computed
  ...
  gl.uniform1f(Uc.uBloomStr, 0.45); /* 0.60 */
